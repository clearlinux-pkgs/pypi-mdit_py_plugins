...
Source0  : https://files.pythonhosted.org/packages/25/f5/5b9caa98f480ba38f15236a4049ff7d7a803735081d83d4997b2b12b27d3/mdit-py-plugins-0.3.4.tar.gz
...
%prep
%setup -q -n mdit-py-plugins-0.3.4
cd %{_builddir}/mdit-py-plugins-0.3.4
pushd ..
cp -a mdit-py-plugins-0.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676770028
