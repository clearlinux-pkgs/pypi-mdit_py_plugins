...
Source0  : https://files.pythonhosted.org/packages/49/e7/cc2720da8a32724b36d04c6dba5644154cdf883a1482b3bbb81959a642ed/mdit-py-plugins-0.3.5.tar.gz
...
%prep
%setup -q -n mdit-py-plugins-0.3.5
cd %{_builddir}/mdit-py-plugins-0.3.5
pushd ..
cp -a mdit-py-plugins-0.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677860476
